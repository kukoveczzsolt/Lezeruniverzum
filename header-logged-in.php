    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
          ...
          <button onclick="window.location.href='login.php';" type="button" class="btn btn-outline-dark text-black">Felhasználói adatok</button>
          <button onclick="window.location.href='registration.php';" type="button" class="btn btn-outline-dark text-black">Kijelentkezés</button>
