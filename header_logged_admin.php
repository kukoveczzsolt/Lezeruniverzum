  ...
  <header class="p-3 primary-bg">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
          <div class="dropdown">
            <button class="btn primary" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              <?php echo $_SESSION["email"]; ?>
            </button>
            <ul class="dropdown-menu primary-bg">
              <li><a class="dropdown-item primary" href="user.php">Profil</a></li>
              <li><a class="dropdown-item primary" href="orders.php">Rendelések</a></li>
              <li><a class="dropdown-item primary" href="admin_panel.php#nev_kereses">Admin</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item primary" href="logout.php"> Kijelentkezés </a></li>
            </ul>
