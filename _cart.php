                    ...
                    <div class="col-lg-9">
                        <div class="card border shadow-0">
                            <div class="m-4">
                                ...
                                <div class="row gy-3 mb-4">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-6 d-flex flex-row flex-lg-column flex-xl-row text-nowrap">
                                        ...
                                        <div class="">
                                            <text class="h6">10000 Ft</text> <br />
                                            <small class="text-muted text-nowrap"> 1500 Ft / db </small>
                                        </div>
                                    </div>
                                    <div class="col-lg col-sm-6 d-flex justify-content-sm-center justify-content-md-start justify-content-lg-center justify-content-xl-end mb-2">
                                        <div class="float-md-end">
                                            <a href="#" class="btn btn-light border text-danger icon-hover-danger">Törlés</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row gy-3 mb-4">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-6 d-flex flex-row flex-lg-column flex-xl-row text-nowrap">
                                        ...
                                        <div class="">
                                            <text class="h6">1800 Ft</text> <br />
                                            <small class="text-muted text-nowrap"> 6500 Ft / db </small>
                                        </div>
                                    </div>
                                    <div class="col-lg col-sm-6 d-flex justify-content-sm-center justify-content-md-start justify-content-lg-center justify-content-xl-end mb-2">
                                        <div class="float-md-end">
                            ...
                            <div class="border-top pt-4 mx-4 mb-4">
                                <p><i class="fas fa-truck text-muted fa-lg"></i> Ingyenes szállítás</p>
                                <p class="text-muted">
                        ...
                        <!-- summary -->
                        <div class="float-end">
                            <button class="btn btn-success shadow-0 border">Tovább</i></button>
                        </div>
                    </div>
                    <!-- cart -->
                </div>
