...
function tabla_feltoltes()
{
    ...
    while($row = mysqli_fetch_assoc($result))
    {
        ...
        echo "<form action='update_product.php' method='post'><td><button type='submit' class='btn btn-warning' name='update' value='".$row["ID"]."'><i class='bi bi-pencil-square'></i></form>  <form action='delete.php' method='post'></button> <button type='submit' class='btn btn-danger' name='delete' value='".$row["nev"]."'><i class='bi bi-trash-fill'></i></button></td></form>";
        echo "</tr>";
    }
}
